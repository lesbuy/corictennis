...
awk -F"\t" -v flop=$flop -v calc=$calc '$15 == "s" && $8 >= flop && $8 < calc' $DATA/activity/atp/* $DATA/calc/atp/s/mandatory0 > $DATA/calc/atp/s/year/flop
awk -F"\t" -v curr=$curr -v calc=$calc '$15 == "s" && $8 >= calc && $8 < curr' $DATA/activity/atp/* $DATA/calc/atp/s/mandatory0 > $DATA/calc/atp/s/year/loaded

awk -F"\t" -v flop=$flop -v calc=$calc '$15 == "d" && $8 >= flop && $8 < calc' $DATA/activity/atp/*  > $DATA/calc/atp/d/year/flop
awk -F"\t" -v curr=$curr -v calc=$calc '$15 == "d" && $8 >= calc && $8 < curr' $DATA/activity/atp/*  > $DATA/calc/atp/d/year/loaded
