...
class Calendar extends CalendarBase {
	...
	protected function download() {
		if ($this->mode != "local") {
			$this->url = "https://www.itftennis.com/Umbraco/Api/TournamentApi/GetCalendar?circuitCode=MT&searchString=&skip=0&take=100&nationCodes=&zoneCodes=&dateFrom=$this->start&dateTo=$this->end&indoorOutdoor=&categories=&isOrderAscending=true&orderField=startDate&surfaceCodes=";
...
$calendar = new Calendar("itf-men", $start, $end);
