...
class GSRecordController extends Controller
{
	...
	private $t2020_atp = ['M024', 'M009', '0352'];
	private $t2011_atp = ['M006', 'M007', '0410', 'M021', 'M009', '0421', 'M024', '5014', '0352'];
	private $t2009_atp = ['M006', 'M007', '0410', 'M009', 'M021', '0421', 'M024', '5014', '0352'];
	private $t2002_atp = ['M006', 'M007', '0410', 'M009', '0414', '0421', 'M024', 'M021', '0352'];
	private $t2000_atp = ['M006', 'M007', '0410', 'M009', '0414', '0421', 'M024', '0357', '0352'];
	private $t1996_atp = ['M006', 'M007', '0410', '0414', 'M009', '0421', 'M024', '0357', '0352'];
	private $t1995_atp = ['M006', 'M007', '0410', '0414', 'M009', '0421', 'M024', '0430', '0352'];
	private $t1990_atp = ['M006', 'M007', '0410', '0414', 'M009', '0421', 'M024', '0429', '0352'];

	private $t2020_wta = ['1003', 'M024', 'M009'];
	private $t2019_wta = ['0718', 'M006', 'M007', 'M021', 'M009', '0806', 'M024', '1075', 'M015'];
	private $t2018_wta = ['1003', 'M006', 'M007', 'M021', 'M009', '0806', 'M024', '1075', 'M015'];
	private $t2017_wta = ['0718', 'M006', 'M007', 'M021', 'M009', '0806', 'M024', '1075', 'M015'];
	private $t2016_wta = ['1003', 'M006', 'M007', 'M021', 'M009', '0806', 'M024', '1075', 'M015'];
	private $t2015_wta = ['0718', 'M006', 'M007', 'M021', 'M009', '0806', 'M024', '1075', 'M015'];
	private $t2014_wta = ['1003', 'M006', 'M007', 'M021', 'M009', '0806', 'M024', '1075', 'M015'];
	private $t2012_wta = ['1003', 'M006', 'M007', 'M021', 'M009', '0806', 'M024', '1056', 'M015'];
	private $t2011_wta = ['0718', 'M006', 'M007', 'M021', 'M009', '0806', 'M024', '1056', 'M015'];
	private $t2009_wta = ['0718', 'M006', 'M007', 'M009', 'M021', '0806', 'M024', '1056', 'M015'];
	private $t2008_wta = ['1003', 'M006', 'M007', '0804', '10642', 'M009', '0806', '1056', 'M014'];
	private $t2004_wta = ['1056', 'M006', 'M007', '0804', '10642', 'M009', '10342', '0806', 'M014', '10542'];
	private $t2001_wta = ['1056', 'M006', 'M007', '0804', '10642', 'M009', '0806', 'M014', '10542'];
	private $t2000_wta = ['1056', 'M006', 'M007', '0804', '10642', 'M009', '0806', '10542', 'M014'];
	private $t1997_wta = ['1056', 'M006', 'M007', '0804', 'M009', '10642', '0806', '10542', 'M014'];
	private $t1996_wta = ['1056', 'M007', '0804', 'M009', '10642', '0806', '10542'];
	private $t1993_wta = ['1056', 'M007', '0804', 'M009', '10642', '0806', '10542', '10468'];
	private $t1991_wta = ['10735', 'M007', '0804', 'M009', '10642', '0806'];
	private $t1990_wta = ['10650', 'M007', '0804', 'M009', '10642', '0806'];
